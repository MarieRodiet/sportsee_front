...
function Dashboard({ urlForUseFetch }) {
    ...
    return (
        <div className="App-Dashboard">
            {/* LEFTNAV */}
            <div className="App-Dashboard-LeftNav">
                <div className="App-Dashboard-LeftNav-Icons">
                    {/* YOGA */}
                    <div className="App-Dashboard-LeftNav-Icons-Box">
                        <svg
                            width="64"
                            height="64"
                            viewBox="0 0 64 64"
                ...
                <p className="App-Dashboard-LeftNav-Text">
            ...
            {formated ? (
                <div className="App-Dashboard-container">
                    <div className="App-Dashboard-container-greeting">
                        <h1>Bonjour</h1>
                        <h1 className="App-Dashboard-container-greeting-name">
                    ...
                    <div className="App-Dashboard-container-data">
                        <div className="App-Dashboard-container-data-recharts">
                            <DailyActivityBarChart
                                urlForUseFetch={urlForUseFetch}
                            />
                            <div className="App-Dashboard-container-data-recharts-charts">
                                <AverageLineChart
                                    urlForUseFetch={urlForUseFetch}
                                />
